...
let CumulativeSummaryComponent = class CumulativeSummaryComponent {
    constructor(router, http, cumulativeSummaryService, location) {
        this.router = router;
        this.http = http;
...
let QuizComponent = class QuizComponent {
    constructor(route, http, quizService, cookieService, location, router, dialog) {
        this.route = route;
        this.http = http;
    ...
    onSubmit(form) {
         ...
         */
        const dialogRef = this.dialog.open(_shared_quiz_summary_dialog_quiz_summary_dialog_component__WEBPACK_IMPORTED_MODULE_9__["QuizSummaryDialogComponent"], {
            data: {
