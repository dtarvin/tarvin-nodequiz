...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.goToCumulativeSummary = function () {
...
module.exports = ".cumulativeSummaryPage {\n    width: 80%;\n    /* margin-top: 2%; */\n    margin:0 auto;\n}\n\nmat-card {\n    background-color: #9ccc9c;\n}\n\n.mat-title {\n    text-align: center;\n}\n\n.cumulativeSummaryTable {\n    width: 60%;\n    margin: 0 auto;\n}\n\ntd {\n    text-align: center;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CumulativeSummaryComponent = /** @class */ (function () {
    function CumulativeSummaryComponent(router, http, cumulativeSummaryService, location) {
        var _this = this;
        this.router = router;
        this.http = http;
        ...
        this.cumulativeSummaryService.getCumulativeSummary()
            ...
            _this.completedQuizzes = res;
            console.log('The completed quizzes are: ' + _this.completedQuizzes);
        });
    }
    CumulativeSummaryComponent.prototype.goBack = function () {
        this.location.back();
    };
...
var CumulativeSummaryService = /** @class */ (function () {
    function CumulativeSummaryService(http) {
        this.http = http;
    }
    CumulativeSummaryService.prototype.getCumulativeSummary = function () {
        console.log('Running getCumulativeSummary from Service');
        return this.http.get('/api/completedQuizzes');
    };
    CumulativeSummaryService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return CumulativeSummaryService;
}());
...
module.exports = "* {\n    background-color: lightgreen;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".mat-card {\n    background-color: #649568;\n}\n\ndiv.ui-widget-header {\n    background-color: #2b5329;\n}\n\n.mat-raised-button {\n    background-color: #2b5329;\n    color: white;\n    /* width: 30%; */\n    margin: auto;\n}\n\n.carousel {\n    background-color: #9ccc9c;\n    width: 70%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "ul {\n  list-style-type: none;\n}\n\n.container {\n  margin: auto;\n  /* margin-top: 2%;\n  width: 50%; */\n}\n\nmat-card {\n  background-color: #649568;\n}\n\nmat-card-content mat-card {\n  background-color: #9ccc9c;\n  width: 60%;\n  margin: auto;\n}\n\n.mat-raised-button {\n    background-color: #2b5329;\n    color: white;   \n}\n\nmat-card-actions {\n  text-align: center;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _shared_quiz_summary_dialog_quiz_summary_dialog_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../shared/quiz-summary-dialog/quiz-summary-dialog.component */ "./src/app/shared/quiz-summary-dialog/quiz-summary-dialog.component.ts");
/*
; ============================================
...
var QuizComponent = /** @class */ (function () {
    function QuizComponent(route, http, quizService, cookieService, location, router, dialog) {
        var _this = this;
        this.route = route;
        this.http = http;
        ...
        this.quizService.getQuizzes()
            ...
            _this.quiz = _this.quizzes.filter(function (q) { return q.name === _this.quizName; })[0];
    ...
    QuizComponent.prototype.onSubmit = function (form) {
        ...
        var questionCount = this.questions.length; // the total number of quiz questions
        ...
        try {
            ...
            //  */
            for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.questions), _d = _c.next(); !_d.done; _d = _c.next()) {
                var question = _d.value;
                try {
                    for (var _e = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](question.answers), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var answer = _f.value;
         ...
         */
        var dialogRef = this.dialog.open(_shared_quiz_summary_dialog_quiz_summary_dialog_component__WEBPACK_IMPORTED_MODULE_9__["QuizSummaryDialogComponent"], {
            data: {
...
/*!*********************************!*\
  !*** ./src/app/shared/index.ts ***!
  \*********************************/
/*! exports provided: DashboardComponent, LoginComponent, CumulativeSummaryComponent, NotFoundComponent, BaseLayoutComponent, AuthLayoutComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
module.exports = "* {\n    background-color: lightgreen;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var QuizSummaryDialogComponent = /** @class */ (function () {
    function QuizSummaryDialogComponent(dialogRef, data, cookieService, router) {
    ...
    QuizSummaryDialogComponent.prototype.returnToDashboard = function () {
        this.router.navigate(['/dashboard/']);
    };
